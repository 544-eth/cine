    ...
    <div className='  bg-gray-200 '>
        <div className=' h-20 w-[95%] m-auto flex flex-row items-center justify-between'>
            <div className=' flex flex-row items-center gap-20'>
                <div>
                    <h1 className='  text-orange-700 text-[30px] font-bold'>CineGo</h1>
                </div>
                <div className=' flex  '>
            ...
            <div className=' flex flex-row items-center gap-10'>
                    <div className=' flex flex-row gap-5 '>
                        ...
                        <GoQuestion className=' cursor-pointer text-[30px]'/>
                    </div>
                    <div className=' flex flow-row gap-10'>
                        <button className=' ring-2 ring-orange-700 p-2 w-40  rounded-3xl'>Log in</button>
